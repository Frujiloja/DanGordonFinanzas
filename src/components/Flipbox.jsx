...
const FlipBoxGrid = () => {
  const cardsData = [
    ...
    { title: "Asesoría en análisis económico-financiero para tesis", backContent: "Análisis del negocio (proyección de estados contables, ratios), valuación de proyectos, VAN, TIR, índice de rentabilidad, payback." },
  ];
